...
static void _cffi_d_evaluate_A(double const * x0, double const * x1, double const * x2, size_t x3, double const * * x4, double * x5, double * x6, double * x7)
{
  evaluate_A(x0, x1, x2, x3, x4, x5, x6, x7);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_evaluate_A(PyObject *self, PyObject *args)
{
  double const * x0;
  double const * x1;
  double const * x2;
  ...
  if (!PyArg_UnpackTuple(args, "evaluate_A", 8, 8, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6, &arg7))
    return NULL;
...
#else
#  define _cffi_f_evaluate_A _cffi_d_evaluate_A
#endif

static const struct _cffi_global_s _cffi_globals[] = {
  { "evaluate_A", (void *)_cffi_f_evaluate_A, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_evaluate_A },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__field_A(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__field_A(void) { return NULL; }
#  else
     init_field_A(void) { }
#  endif
#  endif
...
PyMODINIT_FUNC
PyInit__field_A(void)
{
  return _cffi_init("_field_A", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_field_A(void)
{
  _cffi_init("_field_A", 0x2601, &_cffi_type_context);
}
#endif
