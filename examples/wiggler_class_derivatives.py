...
class WigglerFull:
    ...
    def set_segments(self):
        ...
        segs_Bx = [self.field_fitter.export_piecewise_segments("Bx", der=n) for n in range(N)]
        segs_By = [self.field_fitter.export_piecewise_segments("By", der=n) for n in range(N)]
        segs_Bs = self.field_fitter.export_piecewise_segments("Bs", der=0)
